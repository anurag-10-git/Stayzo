...
const BookmarkButton = ({ property }) => {
  ...
  const handleClick = async () => {
    if (!userId) {
      toast.error('Not signed in to bookmark');
      return;
    }
  ...
  const bookmarkClass = !isBookmarked
    ...
    : 'bg-red-500 hover:bg-red-600 text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center';

  return (
    <button onClick={handleClick} className={bookmarkClass}>
